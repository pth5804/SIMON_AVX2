...
void simon32_64_Enc_SIMD_16blocks(uint16_t key[], uint16_t plaintext[], uint16_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
    __m256i data1, data2, data3, data4, data5, data6;
	...
	for(i=0; i<32; i++){
		...
		// ROL8(left)
		data4 = ROT16_L8(data2);

		// ROL1(left) & ROL8(left)
		data5 = AND(data3, data4);
		
		// right = right ^ ROL5(left) & ROL8(left)
		data1 = XOR(data1, data5);

		// ROL2(left)
		data6 = ROT16_L2(data2);

		// right = right ^ ROL5(left) & ROL8(left) ^ ROL2(left)
		data1 = XOR(data1, data6);
...
void simon32_64_Enc_SIMD_32blocks(uint16_t key[], uint16_t plaintext[], uint16_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
	...
	for(i=0; i<32; i++){
		...
		// ROL8(left)
		data7 = ROT16_L8(data2);
		data8 = ROT16_L8(data4);

		// ROL1(left) & ROL8(left)
		data7 = AND(data5, data7);
		data8 = AND(data6, data8);
		
		// right = right ^ (ROL1(left) & ROL8(left))
		data1 = XOR(data1, data7);
		data3 = XOR(data3, data8);

		// ROL2(left)
		data5 = ROT16_L2(data2);
		data6 = ROT16_L2(data4);

		// right = (right ^ (ROL1(left) & ROL8(left))) ^ ROL2(left)
		data1 = XOR(data1, data5);
...
void simon32_64_Enc_SIMD_48blocks(uint16_t key[], uint16_t plaintext[], uint16_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
    __m256i data1, data2, data3, data4, data5, data6, data7, data8;
	...
	for(i=0; i<32; i++){
		...
		// ROL8(left)
		data10 = ROT16_L8(data2);
		data11 = ROT16_L8(data4);
		data12 = ROT16_L8(data6);

		// ROL5(left) & ROL8(left)
		data10 = AND(data7, data10);
		data11 = AND(data8, data11);
		data12 = AND(data9, data12);
		...
		// ROL2(left)
		data7 = ROT16_L2(data2);
		data8 = ROT16_L2(data4);
		data9 = ROT16_L2(data6);
...
void simon32_64_Enc_SIMD_64blocks(uint16_t key[], uint16_t plaintext[], uint16_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
    __m256i data1, data2, data3, data4, data5, data6, data7, data8;
	...
	for(i=0; i<32; i++){
		...
		// ROL8(left)
		data13 = ROT16_L8(data2);
		data14 = ROT16_L8(data4);
		data15 = ROT16_L8(data6);
		data16 = ROT16_L8(data8);

		// ROL1(left) & ROL8(left)
		data13 = AND(data9, data13);
		data14 = AND(data10, data14);
		data15 = AND(data11, data15);
		data16 = AND(data12, data16);
		...
		// ROL2(left)
		data9 = ROT16_L2(data2);
		data10 = ROT16_L2(data4);
		data11 = ROT16_L2(data6);
		data12 = ROT16_L2(data8);
