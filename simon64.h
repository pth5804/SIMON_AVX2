...
void simon64_128_Enc_SIMD_8blocks(uint32_t key[], uint32_t plaintext[], uint32_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
	...
	for(i=0; i<44; i++){
		...
		// ROL8(left)
		data4 = ROT32_L8(data2);

		// ROL1(left) & ROL8(left)
		data4 = AND(data3, data4);
		
		// right = right ^ (ROL1(left) & ROL8(left))
		data1 = XOR(data1, data4);

		// ROL2(left)
		data3 = ROT32_L2(data2);

		// right = (right ^ (ROL1(left) & ROL8(left))) ^ ROL1(left)
...
void simon64_128_Enc_SIMD_16blocks(uint32_t key[], uint32_t plaintext[], uint32_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
	...
	for(i=0; i<44; i++){
		...
		data6 = ROT32_L1(data4);

		// ROL8(left)
		data7 = ROT32_L8(data2);
		data8 = ROT32_L8(data4);
		...
		// ROL2(left)
		data7 = ROT32_L2(data2);
		data8 = ROT32_L2(data4);
		...
		// left = ((right ^ (ROL1(left) & ROL8(left))) ^ ROL2(left)) ^ rk
...
void simon64_128_Enc_SIMD_24blocks(uint32_t key[], uint32_t plaintext[], uint32_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
    __m256i data1, data2, data3, data4, data5, data6, data7, data8;
	...
	for(i=0; i<44; i++){
		...
		// ROL8(left)
		data10 = ROT32_L8(data2);
		data11 = ROT32_L8(data4);
		data12 = ROT32_L8(data6);
...
void simon64_128_Enc_SIMD_32blocks(uint32_t key[], uint32_t plaintext[], uint32_t ciphertext[]){
	int i = 0;
	//AVX2 SIMD
    __m256i data1, data2, data3, data4, data5, data6, data7, data8;
    __m256i data9, data10, data11, data12, data13, data14, data15, data16;
	...
	for(i=0; i<44; i++){
		...
		// ROL8(left)
		data13 = ROT32_L8(data2);
		data14 = ROT32_L8(data4);
		data15 = ROT32_L8(data6);
		data16 = ROT32_L8(data8);
		...
		// ROL2(left)
		data9 = ROT32_L2(data2);
		data10 = ROT32_L2(data4);
		data11 = ROT32_L2(data6);
		data12 = ROT32_L2(data8);
